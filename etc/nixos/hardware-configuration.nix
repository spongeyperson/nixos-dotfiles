...
{ 
  ...
  fileSystems."/mnt/Samba/NAS" = {
    ...
    options = let
      ...
      automount_opts = "_netdev,noauto,nofail,rw,users,uid=tyler,iocharset=utf8,file_mode=0777,dir_mode=0777,x-systemd.automount,x-systemd.idle-timeout=60,x-systemd.device-timeout=5s,x-systemd.mount-timeout=5s,noserverino";
